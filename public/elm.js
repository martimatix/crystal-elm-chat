		...
		switch (_p0.ctor) {
			case 'PostChatMessage':
				...
				return A2(
					...
					{
						ctor: '::',
						_0: A3(_user$project$Main$submitChatMessage, username, message, host),
						_1: {ctor: '[]'}
					});
			case 'UpdateUserMessage':
				return A2(
					...
					{ctor: '[]'});
			case 'NewChatMessage':
				var messages = {ctor: '::', _0: _p0._0, _1: model.chatMessages};
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
...
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {chatMessages: a, userMessage: b, username: c, usernameSelected: d, websocketHost: e};
	});
...
var _user$project$Main$SelectUsername = {ctor: 'SelectUsername'};
var _user$project$Main$UpdateUsername = function (a) {
	return {ctor: 'UpdateUsername', _0: a};
};
var _user$project$Main$enterNameView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Enter your username for this chat'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$SelectUsername),
							_1: {
								ctor: '::',
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _user$project$Main$displayChatMessages(model.chatMessages),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$Main$viewSelect = function (model) {
	return model.usernameSelected ? _user$project$Main$chatView(model) : _user$project$Main$enterNameView(model);
};
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Awesome Chat Room'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _user$project$Main$viewSelect(model),
				_1: {ctor: '[]'}
			}
		});
};
